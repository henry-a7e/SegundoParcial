...
ActiveRecord::Schema.define(version: 2021_06_14_213510) do
  ...
  create_table "medical_centers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["medical_center_id"], name: "index_medical_centers_on_medical_center_id"
  end
  ...
  add_foreign_key "medical_centers", "medical_centers"
